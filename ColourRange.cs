namespace Blueberry
{
    ...
    /// <summary>Defines a closed range of colour.</summary>
    [Serializable]
    public struct ColourRange : IEquatable<ColourRange>, IFormattable
    {
        ...
        /// <summary>
        /// Implicit cast operator from Color to ColourRange.
        /// </summary>
        /// <param name="value">A color instance.</param>
        /// <returns>A new ColourRange object.</returns>
        static public implicit operator ColourRange(Color value)
        {
            return new ColourRange
            {
                Red = (Range)((float)value.R / 255f),
                Green = (Range)((float)value.G / 255f),
                Blue = (Range)((float)value.B / 255f)
            };
        }
        /// <summary>
        /// Implicit cast operator from Color to ColourRange.
        ...
        /// <param name="value">A color instance.</param>
        /// <returns>A new ColourRange object.</returns>
        static public implicit operator ColourRange(Color4 value)
        {
            return new ColourRange
            {
                Red = (Range)(value.R ),
