...
namespace Blueberry.Tiled
{
    ...
    public struct Line
    {
        ...
        public static void Draw(SpriteBatch spriteBatch, Line line, Rectangle region, Texture2D texture,
                                Single lineWidth, Color color, Single layerDepth)
        {
        ...
        */
        ...
        public Boolean Intersects(ref Rectangle rect)
        {
            ...
            if (this.Intersects(Line.FromPoints(new Vector2(rect.Right, rect.Top), new Vector2(rect.Right, rect.Bottom))))
                return true;
            if (
                this.Intersects(Line.FromPoints(new Vector2(rect.Right, rect.Bottom),
