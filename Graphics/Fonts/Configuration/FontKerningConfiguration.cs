...
namespace Blueberry.Graphics.Fonts
{
    ...
    {
        /// <summary>Ordinary kerning</summary>
        Normal,
        /// <summary>
    ...
    {
        /// <summary>Kerning rules for particular characters</summary>
        ...
        /// <summary>Sets all characters in the given string to the specified kerning rule.</summary>
        ...
        /// <summary>Sets the specified character kerning rule.</summary>
        /// <param name="c"></param>
        /// <param name="rule"></param>
        ...
        /// <summary>Given a pair of characters, this will return the overriding CharacterKerningRule.</summary>
