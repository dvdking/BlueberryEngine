...
{
    internal class HelperBitmap
    {
        public Bitmap bitmap;
        public BitmapData bitmapData;

        public HelperBitmap(string filePath)
        {
            LockBits(new Bitmap(filePath));
        }

        public HelperBitmap(Bitmap bitmap)
        {
            LockBits(bitmap);
        }
        ...
        /// <summary>Returns try if the given pixel is empty (i.e. black)</summary>
        ...
        /// <summary>Returns try if the given pixel is empty (i.e. alpha is zero)</summary>
        ...
        /// <summary>Blits from source to target. Both source and target must be 32-bit</summary>
        ...
        /// <summary>Sets colour without touching alpha values</summary>
        /// <param name="r"></param>
        /// <param name="g"></param>
        /// <param name="b"></param>
